...
test.describe('[QS-242] Verify promo expiration date is hidden when promoExpirationDateEnabled is false', { tag: ['@functional', '@promo'] }, () => {
  let promoPage;

  test('[QS-242][TC-001] Verify expiration date is hidden on promo tile and drawer', async ({ page }) => {
