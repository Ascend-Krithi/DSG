...
test.describe('[QS-243] Verify promo expiration date is hidden when promoExpirationDateEnabled is false', { tag: ['@functional', '@promo'] }, () => {
  let promoPage;

  test('[QS-243][TC-001] Verify expiration date is hidden on promo tile and drawer', async ({ page }) => {
